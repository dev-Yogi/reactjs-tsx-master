            ...
            <div className="container mt-3">
                <div className="row">
                    <div className="col">
                        ...
                        <p className="fst-italic">Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit adipisci nesciunt eos vero, laudantium, molestiae minus nostrum itaque eveniet assumenda ut est ipsam mollitia nulla placeat voluptate distinctio dolorum dicta!</p>
                    </div>
                </div>
